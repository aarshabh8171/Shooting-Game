...
# LOAD SPACESHIPS 
RED_SPACESHIP = pygame.image.load(os.path.join("assets", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\pixel_ship_red_small.png"))
BLUE_SPACESHIP = pygame.image.load(os.path.join("assets", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\pixel_ship_blue_small.png"))
GREEN_SPACESHIP = pygame.image.load(os.path.join("assets", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\pixel_ship_green_small.png"))
YELLOW_SPACESHIP = pygame.image.load(os.path.join("assets", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\pixel_ship_yellow.png"))

# LOAD LASERS
RED_LASER = pygame.image.load(os.path.join("assets", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\pixel_laser_red.png"))
BLUE_LASER = pygame.image.load(os.path.join("assets", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\pixel_laser_blue.png"))
GREEN_LASER = pygame.image.load(os.path.join("assets", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\pixel_laser_green.png"))
YELLOW_LASER = pygame.image.load(os.path.join("assets", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\pixel_laser_yellow.png"))

# LOAD BACKGROUND
BG = pygame.transform.scale(pygame.image.load(os.path.join("assets","C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\spacefield_a-000-preview.png")), (WIDTH, HEIGHT))

# LOAD SOUND EFFECTS
explosion_sound = pygame.mixer.Sound(os.path.join("music", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\music_explosion.wav"))
laser_sound = pygame.mixer.Sound(os.path.join("music", "C:\\Users\\91817\\OneDrive\\Desktop\\python\\shooting game files\\music_laser.wav"))
